...
Remarque :  Le fichier du modèle IA `vgg16_skin_cancer.h5` étant trop lourd pour les restrictions de stockage de GitHub (>100 Mo), il doit être téléchargé séparément et placé manuellement dans le dossier `model/` avant le lancement.
